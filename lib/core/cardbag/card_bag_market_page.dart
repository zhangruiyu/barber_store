...
class CardBagMarketPage extends StatefulWidget {
  @override
  _CardBagMarketPageState createState() => _CardBagMarketPageState();
}

class _CardBagMarketPageState extends State<CardBagMarketPage> {
          ...
          return Card(
            ...
            child: Row(
              children: <Widget>[
                ...
                MaterialButton(
                  onPressed: () {
                    setCardBagStatePre(itemData.id);
                  },
                  child: Text("转为准备中"),
                  height: 100.0,
  ...
  Future<Null> refreshData() {
    ...
    RequestHelper.allCardBagByType(1).then((onValue) {
      setState(() {
        data.clear();
  ...
  void setCardBagStatePre(int cardBagId) {
    NavigatorHelper.showLoadingDialog(true);
    RequestHelper.setCardBagStateByState(0, cardBagId).then((onValue) {
